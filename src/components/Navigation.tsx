...
export const Navigation: React.FC<NavigationProps> = ({ onAboutClick, onDeveloperClick }) => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-gradient-to-r from-gray-900/80 via-gray-800/80 to-gray-900/80 backdrop-blur-md border-b border-gray-700/50 dark:from-gray-900/80 dark:via-gray-800/80 dark:to-gray-900/80">
