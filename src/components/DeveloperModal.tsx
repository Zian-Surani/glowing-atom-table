...
export const DeveloperModal: React.FC<DeveloperModalProps> = ({
  ...
  return <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-2 sm:p-4 animate-fade-in">
      <div className="bg-gray-900 rounded-xl sm:rounded-2xl p-4 sm:p-6 max-w-sm sm:max-w-lg w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto border border-gray-700 animate-scale-in">
        ...
        <div className="flex justify-between items-start mb-4 sm:mb-6">
          ...
          <button onClick={onClose} className="p-1.5 sm:p-2 hover:bg-gray-800 rounded-lg transition-colors">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-gray-400 mb-3">Full-Stack Developer &amp; Not a Big Chemistry Enthusiast</p>
            
            {/* LinkedIn Link */}
            <a href="https://www.linkedin.com/in/zian-rajeshkumar-surani-125215195" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors text-white text-sm sm:text-base">
          ...
          <div className="bg-gray-800 rounded-lg p-3 sm:p-4">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {['React', 'TypeScript', 'Tailwind CSS', 'Lucide Icons', 'Vite'].map(tech => <span key={tech} className="px-2 sm:px-3 py-1 bg-gradient-to-r from-blue-500/20 to-purple-500/20 
